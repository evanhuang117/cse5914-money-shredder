...
T = TypeVar("T", bound="LegalAddress")
...
class LegalAddress:
    ...
    Attributes:
        ...
        country_name (Union[Unset, str]): The name of the country of the address.
        county (Union[Unset, str]): The name of the county of the address.
        postal_code (Union[Unset, str]): The postal code of the address.
        state_or_province (Union[Unset, str]): The state or province of the address.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        legal_address.additional_properties = d
