...
T = TypeVar("T", bound="CouponConstraint")
...
class CouponConstraint:
    ...
    Attributes:
        expiration_date (Union[Unset, str]): This timestamp provides the expiration date of the coded coupon.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        coupon_constraint = cls(
            expiration_date=expiration_date,
        )

        coupon_constraint.additional_properties = d
